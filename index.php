...
?>
	...
	<script type="text/javascript" src="js/libraries/moment/min/moment-with-locales.min.js"></script>
	<script type="text/javascript" src="js/libraries/bootstrap-datetimepicker/build/js/bootstrap-datetimepicker.min.js"></script>
	...
	<script src="js/map_small.js"></script>
